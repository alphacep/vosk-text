...
class InverseNormalizer(Normalizer):
    ...
    def __init__(self, lang: str = 'en', cache_dir: str = None, overwrite_cache: bool = False):
        ...
        if lang == 'en':
            from vosk_text.inverse_text_normalization.en.taggers.tokenize_and_classify import ClassifyFst
            from vosk_text.inverse_text_normalization.en.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )

        elif lang == 'es':
            from vosk_text.inverse_text_normalization.es.taggers.tokenize_and_classify import ClassifyFst
            from vosk_text.inverse_text_normalization.es.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )

        elif lang == 'pt':
            from vosk_text.inverse_text_normalization.pt.taggers.tokenize_and_classify import ClassifyFst
            from vosk_text.inverse_text_normalization.pt.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )

        elif lang == 'ru':
            from vosk_text.inverse_text_normalization.ru.taggers.tokenize_and_classify import ClassifyFst
            from vosk_text.inverse_text_normalization.ru.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )

        elif lang == 'de':
            from vosk_text.inverse_text_normalization.de.taggers.tokenize_and_classify import ClassifyFst
            from vosk_text.inverse_text_normalization.de.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )
        elif lang == 'fr':
            from vosk_text.inverse_text_normalization.fr.taggers.tokenize_and_classify import ClassifyFst
            from vosk_text.inverse_text_normalization.fr.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )
        elif lang == 'vi':
            from vosk_text.inverse_text_normalization.vi.taggers.tokenize_and_classify import ClassifyFst
            from vosk_text.inverse_text_normalization.vi.verbalizers.verbalize_final import (
                VerbalizeFinalFst,
            )
