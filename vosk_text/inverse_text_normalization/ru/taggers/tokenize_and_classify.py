...
from vosk_text.inverse_text_normalization.ru.taggers.money import MoneyFst
from vosk_text.inverse_text_normalization.ru.taggers.ordinal import OrdinalFst
from vosk_text.inverse_text_normalization.ru.taggers.telephone import TelephoneFst
from vosk_text.inverse_text_normalization.ru.taggers.time import TimeFst
from vosk_text.inverse_text_normalization.ru.taggers.whitelist import WhiteListFst
...
from vosk_text.text_normalization.ru.taggers.tokenize_and_classify import ClassifyFst as TNClassifyFst
...
class ClassifyFst(GraphFst):
    ...
    def __init__(self, cache_dir: str = None, overwrite_cache: bool = False):
        ...
        if cache_dir is not None and cache_dir != "None":
            ...
            far_file = os.path.join(cache_dir, "ru_itn.far")
