...
import pynini
from vosk_text.inverse_text_normalization.de.taggers.cardinal import CardinalFst
from vosk_text.inverse_text_normalization.de.taggers.date import DateFst
from vosk_text.inverse_text_normalization.de.taggers.decimal import DecimalFst
from vosk_text.inverse_text_normalization.de.taggers.electronic import ElectronicFst
from vosk_text.inverse_text_normalization.de.taggers.fraction import FractionFst
from vosk_text.inverse_text_normalization.de.taggers.measure import MeasureFst
from vosk_text.inverse_text_normalization.de.taggers.money import MoneyFst
from vosk_text.inverse_text_normalization.de.taggers.ordinal import OrdinalFst
from vosk_text.inverse_text_normalization.de.taggers.telephone import TelephoneFst
from vosk_text.inverse_text_normalization.de.taggers.time import TimeFst
from vosk_text.inverse_text_normalization.de.taggers.whitelist import WhiteListFst
from vosk_text.inverse_text_normalization.en.taggers.punctuation import PunctuationFst
from vosk_text.inverse_text_normalization.en.taggers.word import WordFst
from vosk_text.text_normalization.de.taggers.cardinal import CardinalFst as TNCardinalTagger
from vosk_text.text_normalization.de.taggers.date import DateFst as TNDateTagger
from vosk_text.text_normalization.de.taggers.decimal import DecimalFst as TNDecimalTagger
from vosk_text.text_normalization.de.taggers.electronic import ElectronicFst as TNElectronicTagger
from vosk_text.text_normalization.de.taggers.whitelist import WhiteListFst as TNWhitelistTagger
from vosk_text.text_normalization.de.verbalizers.date import DateFst as TNDateVerbalizer
from vosk_text.text_normalization.de.verbalizers.electronic import ElectronicFst as TNElectronicVerbalizer
from vosk_text.text_normalization.de.verbalizers.fraction import FractionFst as TNFractionVerbalizer
from vosk_text.text_normalization.de.verbalizers.ordinal import OrdinalFst as TNOrdinalVerbalizer
from vosk_text.text_normalization.de.verbalizers.time import TimeFst as TNTimeVerbalizer
...
class ClassifyFst(GraphFst):
    ...
    def __init__(self, cache_dir: str = None, overwrite_cache: bool = False, deterministic: bool = True):
        ...
        if cache_dir is not None and cache_dir != 'None':
            ...
            far_file = os.path.join(cache_dir, "de_itn.far")
