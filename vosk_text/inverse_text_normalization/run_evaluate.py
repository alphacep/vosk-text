...
from vosk_text.inverse_text_normalization.inverse_normalize import InverseNormalizer
...
if __name__ == "__main__":
    ...
    args = parse_args()
    if args.lang == 'en':
        from vosk_text.inverse_text_normalization.en.clean_eval_data import filter_loaded_data
