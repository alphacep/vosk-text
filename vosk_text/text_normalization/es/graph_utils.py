...
import pynini
from vosk_text.text_normalization.en.graph_utils import NEMO_SIGMA, NEMO_SPACE
from vosk_text.text_normalization.es import LOCALIZATION
from vosk_text.text_normalization.es.utils import get_abs_path, load_labels
