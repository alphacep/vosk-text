...
from vosk_text.text_normalization.es.taggers.cardinal import CardinalFst
from vosk_text.text_normalization.es.taggers.date import DateFst
from vosk_text.text_normalization.es.taggers.decimals import DecimalFst
from vosk_text.text_normalization.es.taggers.electronic import ElectronicFst
from vosk_text.text_normalization.es.taggers.fraction import FractionFst
from vosk_text.text_normalization.es.taggers.measure import MeasureFst
from vosk_text.text_normalization.es.taggers.money import MoneyFst
from vosk_text.text_normalization.es.taggers.ordinal import OrdinalFst
from vosk_text.text_normalization.es.taggers.telephone import TelephoneFst
from vosk_text.text_normalization.es.taggers.time import TimeFst
from vosk_text.text_normalization.es.taggers.whitelist import WhiteListFst
from vosk_text.text_normalization.es.taggers.word import WordFst
    ...
    def __init__(
        ...
        if cache_dir is not None and cache_dir != "None":
            ...
            far_file = os.path.join(
                cache_dir, f"{input_case}_es_tn_{deterministic}_deterministic{whitelist_file}.far"
            )
