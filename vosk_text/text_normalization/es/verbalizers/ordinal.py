...
import pynini
from vosk_text.text_normalization.en.graph_utils import NEMO_NOT_QUOTE, NEMO_SIGMA, NEMO_SPACE, GraphFst
from vosk_text.text_normalization.es.graph_utils import shift_number_gender
