...
import pynini
from vosk_text.text_normalization.de.utils import get_abs_path
from vosk_text.text_normalization.en.graph_utils import NEMO_DIGIT, GraphFst, convert_space, insert_space
