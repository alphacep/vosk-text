...
from vosk_text.text_normalization.data_loader_utils import (
    load_file,
    post_process_punct,
    pre_process,
    write_file,
)
from vosk_text.text_normalization.token_parser import PRESERVE_ORDER_KEY, TokenParser
...
class Normalizer:
    ...
    def __init__(
        ...
        if lang == "en":
            from vosk_text.text_normalization.en.verbalizers.verbalize_final import VerbalizeFinalFst
            from vosk_text.text_normalization.en.verbalizers.post_processing import PostProcessingFst

            if post_process:
                self.post_processor = PostProcessingFst(cache_dir=cache_dir, overwrite_cache=overwrite_cache)

            if deterministic:
                from vosk_text.text_normalization.en.taggers.tokenize_and_classify import ClassifyFst
            else:
                if lm:
                    from vosk_text.text_normalization.en.taggers.tokenize_and_classify_lm import ClassifyFst
                else:
                    from vosk_text.text_normalization.en.taggers.tokenize_and_classify_with_audio import (
                        ClassifyFst,
                    )
            ...
            from vosk_text.text_normalization.ru.taggers.tokenize_and_classify import ClassifyFst
            from vosk_text.text_normalization.ru.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'de':
            from vosk_text.text_normalization.de.taggers.tokenize_and_classify import ClassifyFst
            from vosk_text.text_normalization.de.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'es':
            from vosk_text.text_normalization.es.taggers.tokenize_and_classify import ClassifyFst
            from vosk_text.text_normalization.es.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'zh':
            from vosk_text.text_normalization.zh.taggers.tokenize_and_classify import ClassifyFst
            from vosk_text.text_normalization.zh.verbalizers.verbalize_final import VerbalizeFinalFst
