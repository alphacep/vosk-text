...
from vosk_text.text_normalization.ru.taggers.money import MoneyFst
from vosk_text.text_normalization.ru.taggers.number_names import get_alternative_formats, get_number_names
from vosk_text.text_normalization.ru.taggers.ordinal import OrdinalFst
from vosk_text.text_normalization.ru.taggers.telephone import TelephoneFst
from vosk_text.text_normalization.ru.taggers.time import TimeFst
from vosk_text.text_normalization.ru.taggers.whitelist import WhiteListFst
from vosk_text.text_normalization.ru.taggers.word import WordFst
    ...
    def __init__(
        ...
        if cache_dir is not None and cache_dir != "None":
            ...
            far_file = os.path.join(
                cache_dir, f"{input_case}_ru_tn_{deterministic}_deterministic{whitelist_file}.far"
            )
